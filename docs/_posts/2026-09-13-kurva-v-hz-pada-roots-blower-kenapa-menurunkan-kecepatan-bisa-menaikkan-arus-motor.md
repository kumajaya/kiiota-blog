...
<div style="overflow-x: auto; margin: 1em 0;">
  <div class="mermaid">
    ...
    ---
    xychart
        title "Arus Motor terhadap Frekuensi Operasi"
        x-axis "Frekuensi (Hz)" [40, 33, 30, 25]
        y-axis "Arus Motor (A)" 180 --&gt; 250
        line [239.5, 200, 202.5, 200.5]
  </div>
</div>
  ...
  <div style="flex: 1 1 320px; min-width: 280px; overflow-x: auto;">
    <div class="mermaid">
      flowchart TD
          ...
          classDef trigger fill:#f8fafc,stroke:#cbd5e1,stroke-width:1.5px,color:#475569
          classDef vfd fill:#ffffff,stroke:#3b82f6,stroke-width:1.5px,color:#1e40af
          classDef decision fill:#ffffff,stroke:#94a3b8,stroke-width:1.5px,color:#334155
          classDef bypass fill:#ffffff,stroke:#f97316,stroke-width:1.5px,color:#9a3412
          classDef endNode fill:#f8fafc,stroke:#cbd5e1,stroke-width:1.5px,color:#475569
          class Start trigger
          class A1 vfd
          class A2 decision
          class A3 bypass
          class Selesai endNode
          linkStyle 2 stroke:#cbd5e1,stroke-width:1.5px,stroke-dasharray:5,5
    </div>
  </div>
  <div style="flex: 1 1 320px; min-width: 280px; overflow-x: auto;">
    <div class="mermaid">
